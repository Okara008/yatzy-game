...
function Game(){
    ...
    const getPlayersStats = async (name) => {
        try {
            const response = await fetch("https://yatzycore.liveblog365.com/api_retrieve_stats.php", {
                method: "POST",
    ...
    const updateOutcome = async (name, outcome, score) => {
        try {
            const response = await fetch("https://yatzycore.liveblog365.com/api_game_outcome.php", {
                method: "POST",
                headers: {"Content-Type": "application/json"},
