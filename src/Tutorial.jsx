...
function Tutorial({wasClicked, removeTutorial}) {
    ...
    const [tutorial_display, set_tutorial_display] = useState([...tutorial_display_ref.current])
    ...
    const update_index = (num) => {
        index_of_display_ref.current = (index_of_display_ref.current + num ) % tutorial_display_ref.current.length
    ...
    return(<>
        {wasClicked && ( <div className="outerShell tutorial_page">
            <section className="tutorialSection">
                ...
                <div className="tutorial_img_display">
                    ...
                    {
                        index_of_display != (tutorial_display_ref.current.length - 1) &&
